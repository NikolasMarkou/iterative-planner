...
[![Tests](https://img.shields.io/badge/tests-529%20passing-brightgreen.svg)](src/scripts/bootstrap.test.mjs)
...
# 529 tests total: bootstrap 223, validate-plan 103, shared 71, schema 48,
...
- [ ] `node --test src/scripts/*.test.mjs` passes (529 tests, 0 failing) and `node src/scripts/check-test-count.mjs` exits 0
