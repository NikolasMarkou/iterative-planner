...
[![Tests](https://img.shields.io/badge/tests-524%20passing-brightgreen.svg)](src/scripts/bootstrap.test.mjs)
...
# 524 tests total: bootstrap 220, validate-plan 103, shared 69, schema 48,
...
- [ ] `node --test src/scripts/*.test.mjs` passes (524 tests, 0 failing) and `node src/scripts/check-test-count.mjs` exits 0
