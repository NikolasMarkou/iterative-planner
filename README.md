...
[![Skill](https://img.shields.io/badge/Skill-v2.36.0-green.svg)](CHANGELOG.md)
[![Tests](https://img.shields.io/badge/tests-527%20passing-brightgreen.svg)](src/scripts/bootstrap.test.mjs)
...
# 527 tests total: bootstrap 223, validate-plan 103, shared 69, schema 48,
...
- [ ] `node --test src/scripts/*.test.mjs` passes (527 tests, 0 failing) and `node src/scripts/check-test-count.mjs` exits 0
