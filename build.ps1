...
function Invoke-Lint {
    ...
    foreach ($script in @("bootstrap.mjs", "validate-plan.mjs", "blast-radius.mjs", "shared.mjs", "check-doc-parity.mjs", "check-readme-parity.mjs", "check-test-count.mjs", "emit-state.mjs", "emit-template.mjs", "schema.mjs")) {
