...
function Invoke-BuildCombined {
    ...
    $refMap = @{
        ...
        '`references/root-cause-analysis.md`' = 'the Root Cause Analysis Methods Reference section below'
        ...
        '`src/references/root-cause-analysis.md`' = 'the Root Cause Analysis Methods Reference section below'
...
function Invoke-Lint {
    ...
    foreach ($script in @("bootstrap.mjs", "validate-plan.mjs", "blast-radius.mjs", "scar-scan.mjs", "shared.mjs", "check-doc-parity.mjs", "check-readme-parity.mjs", "check-changelog-parity.mjs", "check-test-count.mjs", "check-agent-wiring.mjs", "check-template-parity.mjs", "check-register.mjs", "emit-state.mjs", "emit-template.mjs", "schema.mjs")) {
...
function Invoke-Clean {
    ...
    # Generated by check-agent-wiring.mjs --emit-edges during validate (gitignored, never committed)
    if (Test-Path "src/references/kg-edges.jsonl") {
        Remove-Item -Force "src/references/kg-edges.jsonl"
    }
