...
17. **Run 6 Simplification Checks** (`references/complexity-control.md`). Compare against **written criteria**, not memory.
    - **Python/software tasks**: run the 20-item Python anti-pattern checklist in `references/python-software.md` § C as an extra review gate. Skip for non-software plans.
